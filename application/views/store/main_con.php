...
<main  class="el-main">
    <div  class="el-row">
        ...
        <div class="el-table star-page-table employee-mgmt-table el-table--fit el-table--striped el-table--scrollable-x el-table--scrollable-y el-table--enable-row-transition el-table--small">
...
<script src="<?php echo base_url('assets/js/store/main-control.js?v=4'); ?>"></script>
