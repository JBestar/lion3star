...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/control-star.css?v=8');?>">
    <link rel="stylesheet" href="<?php echo base_url('assets/css/star-page-shell.css?v=3');?>">
